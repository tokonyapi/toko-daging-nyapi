    ...
    <div class="container">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <h2 class="text-center text-dark mt-5">Register User</h2>
            <div class="card my-5">
        ...
        <form method="POST" class="card-body cardbody-color p-lg-5" action="{{ route('register') }}">
            @csrf
                ...
                <div class="text-center"><button type="submit" class="btn btn-dark px-5 mb-5 fw-bold">Register</button></div>
                <div class="form-text text-center mb-5 text-dark">Sudah Punya Akun? <a href="{{ route('login') }}" class="text-dark fw-bold"> Login</a>
                </div>
              </form>
            </div>
